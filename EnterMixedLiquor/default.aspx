...
<html lang="en">
	...
	<div class="container-fluid">
		<div class="row">
		<div class="col-lg-12" id="reportHeader"><h1>Wastewater Mixed Liquor Settleability</h1>
		</div>
		</div>
		<iframe id="psofiaForm" src="http://apps.cityoflewisville.com/psofia/default.aspx?form=5" width=100% height=1100>
	...
	<script>
		...
		function init (){
			...
			$("#psofiaForm").contents().find("#submitBtn").click(triggerReport);
		...
		function triggerReport (){
			...
			$("#reportHeader").show();
			$("#topHeaders").show();
			_d = $("#psofiaForm").contents().find("#Date").val();
			_s = $("#psofiaForm").contents().find("#Shift").val();
			...
			$.ajax({
				...
				success: function(e) {
					...
					if (e.results.length === 0){
						...
						$("#dateOfSample").append(e.results[0].Date_);
						$("#shiftReport").append(e.results[0].WorkShift);
						...
						data.addRows([
							[5, e.results[0].Plant1N_5],
							[10, e.results[0].Plant1N_10],
							[15, e.results[0].Plant1N_15],
							[20, e.results[0].Plant1N_20],
							[25, e.results[0].Plant1N_25],
							[30, e.results[0].Plant1N_30]
						]);
